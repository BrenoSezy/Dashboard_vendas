...
#Sempre que abrir o vscode: abrir o terminal e ativar o ambiente virtual
# .\venv\Scripts\activate
#streamlit run Dashboard.py

# Formatação dos números (casa decimal)
...
if filtro_vendedores:
    dados = dados[dados['Vendedore'].isin(filtro_vendedores)]
...
### Tabela de quantidade de vendas por categoria de protudos
...
fig_vendas_mensal = px.line(vendas_mensal,
                            ...
                            color = 'Ano',
                            line_dash = 'Ano',
                            title = 'Quantidade de vendas por mes')
...
with aba2:
    ...
    with coluna2:
        ...
        st.plotly_chart(fig_vendas_categorias, use_container_width=True)
with aba3:
    qtd_vendedores = st.number_input('Quantidade de vendedores', 2, 10, 5) # Valor minimo = 2 vendedores. Valor máximo = 10 vendedores. Valor Padrão = 5
    coluna1, coluna2 = st.columns(2)
    with coluna1:
        st.metric('Receita', formata_numero(dados['Preço'].sum(), 'R$'))
